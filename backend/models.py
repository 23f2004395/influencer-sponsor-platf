...
class Campaign(db.Model):
    ...
    camp_id = db.Column(db.Integer, autoincrement=True, primary_key=True)
    camp_name = db.Column(db.String, nullable=False, unique=True)
...
class AdRequest(db.Model):
    ...
    status = db.Column(db.String(100), nullable=False)  # Pending/Accepted/Rejected
